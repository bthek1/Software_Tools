...
from ...models.list_patient_forms_for_attendee_get_order import (
...
def _get_kwargs(
    ...
    *,
    ...
    order: Union[Unset, ListPatientFormsForAttendeeGetOrder] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/attendees/{attendee_id}/patient_forms",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        order (Union[Unset, ListPatientFormsForAttendeeGetOrder]):
