...
if TYPE_CHECKING:
    ...
    from ..models.list_invoice_items_get_response_200_links import ListInvoiceItemsGetResponse200Links


T = TypeVar("T", bound="ListInvoiceItemsGetResponse200")


@_attrs_define
class ListInvoiceItemsGetResponse200:
    """
    Attributes:
        invoice_items (Union[Unset, List['InvoiceItem']]):
        total_entries (Union[Unset, int]):  Example: 1.
        links (Union[Unset, ListInvoiceItemsGetResponse200Links]):
    """

    invoice_items: Union[Unset, List["InvoiceItem"]] = UNSET
    total_entries: Union[Unset, int] = UNSET
    links: Union[Unset, "ListInvoiceItemsGetResponse200Links"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = ListInvoiceItemsGetResponse200Links.from_dict(_links)

        list_invoice_items_get_response_200 = cls(
            invoice_items=invoice_items,
            total_entries=total_entries,
            links=links,
        )

        list_invoice_items_get_response_200.additional_properties = d
        return list_invoice_items_get_response_200
