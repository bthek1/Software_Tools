...
if TYPE_CHECKING:
    from ..models.create_availability_block_post_body_repeat_rule_type_0 import (
        CreateAvailabilityBlockPostBodyRepeatRuleType0,
    )


T = TypeVar("T", bound="CreateAvailabilityBlockPostBody")


@_attrs_define
class CreateAvailabilityBlockPostBody:
    """
    Attributes:
        ...
        repeat_rule (Union['CreateAvailabilityBlockPostBodyRepeatRuleType0', None, Unset]):
    """
    ...
    repeat_rule: Union["CreateAvailabilityBlockPostBodyRepeatRuleType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.repeat_rule, Unset):
            repeat_rule = UNSET
        elif isinstance(self.repeat_rule, CreateAvailabilityBlockPostBodyRepeatRuleType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_repeat_rule(data: object) -> Union["CreateAvailabilityBlockPostBodyRepeatRuleType0", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                repeat_rule_type_0 = CreateAvailabilityBlockPostBodyRepeatRuleType0.from_dict(data)

                return repeat_rule_type_0
            except:  # noqa: E722
                pass
            return cast(Union["CreateAvailabilityBlockPostBodyRepeatRuleType0", None, Unset], data)

        repeat_rule = _parse_repeat_rule(d.pop("repeat_rule", UNSET))

        create_availability_block_post_body = cls(
        ...
        create_availability_block_post_body.additional_properties = d
        return create_availability_block_post_body
