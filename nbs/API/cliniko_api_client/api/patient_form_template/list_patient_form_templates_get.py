...
from ...models.list_patient_form_templates_get_order import (
...
def _get_kwargs(
    *,
    ...
    order: Union[Unset, ListPatientFormTemplatesGetOrder] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        order (Union[Unset, ListPatientFormTemplatesGetOrder]):
