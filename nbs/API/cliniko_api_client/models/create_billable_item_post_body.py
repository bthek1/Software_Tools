...
from ..models.create_billable_item_post_body_item_type import (
    CreateBillableItemPostBodyItemType,
    check_create_billable_item_post_body_item_type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateBillableItemPostBody")


@_attrs_define
class CreateBillableItemPostBody:
    """
    Attributes:
        item_code (Union[None, Unset, str]):
        item_type (Union[Unset, CreateBillableItemPostBodyItemType]):
    ...
    item_type: Union[Unset, CreateBillableItemPostBodyItemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_item_type, Unset):
            ...
            item_type = check_create_billable_item_post_body_item_type(_item_type)
        ...
        create_billable_item_post_body = cls(
            item_code=item_code,
            item_type=item_type,
            name=name,
            price=price,
        ...
        create_billable_item_post_body.additional_properties = d
        return create_billable_item_post_body
