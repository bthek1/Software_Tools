...
from ...models.list_treatment_notes_for_patient_get_order import (
...
def _get_kwargs(
    ...
    *,
    ...
    order: Union[Unset, ListTreatmentNotesForPatientGetOrder] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/patients/{patient_id}/treatment_notes",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        order (Union[Unset, ListTreatmentNotesForPatientGetOrder]):
