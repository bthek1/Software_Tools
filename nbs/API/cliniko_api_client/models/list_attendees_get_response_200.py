...
if TYPE_CHECKING:
    ...
    from ..models.list_attendees_get_response_200_links import ListAttendeesGetResponse200Links


T = TypeVar("T", bound="ListAttendeesGetResponse200")


@_attrs_define
class ListAttendeesGetResponse200:
    """
    Attributes:
        attendees (Union[Unset, List['Attendee']]):
        total_entries (Union[Unset, int]):  Example: 1.
        links (Union[Unset, ListAttendeesGetResponse200Links]):
    """

    attendees: Union[Unset, List["Attendee"]] = UNSET
    total_entries: Union[Unset, int] = UNSET
    links: Union[Unset, "ListAttendeesGetResponse200Links"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = ListAttendeesGetResponse200Links.from_dict(_links)

        list_attendees_get_response_200 = cls(
            attendees=attendees,
            total_entries=total_entries,
            links=links,
        )

        list_attendees_get_response_200.additional_properties = d
        return list_attendees_get_response_200
