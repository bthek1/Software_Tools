...
T = TypeVar("T", bound="CreatePractitionerReferenceNumberPostBody")


@_attrs_define
class CreatePractitionerReferenceNumberPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_practitioner_reference_number_post_body = cls(
            name=name,
        ...
        create_practitioner_reference_number_post_body.additional_properties = d
        return create_practitioner_reference_number_post_body
