...
from ...models.list_appointment_types_for_practitioner_get_order import (
...
def _get_kwargs(
    ...
    *,
    ...
    order: Union[Unset, ListAppointmentTypesForPractitionerGetOrder] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/practitioners/{practitioner_id}/appointment_types",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        order (Union[Unset, ListAppointmentTypesForPractitionerGetOrder]):
