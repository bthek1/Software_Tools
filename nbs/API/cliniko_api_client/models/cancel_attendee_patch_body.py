...
from ..models.cancel_attendee_patch_body_cancellation_reason import (
    CancelAttendeePatchBodyCancellationReason,
    check_cancel_attendee_patch_body_cancellation_reason,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CancelAttendeePatchBody")


@_attrs_define
class CancelAttendeePatchBody:
    """
    Attributes:
        cancellation_note (Union[None, Unset, str]):
        cancellation_reason (Union[Unset, CancelAttendeePatchBodyCancellationReason]): | Enum Value | Description |
            |---|---|
            |10|Feeling better|
            |20|Condition worse|
            |30|Sick|
    ...
    cancellation_reason: Union[Unset, CancelAttendeePatchBodyCancellationReason] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        cancellation_reason: Union[Unset, CancelAttendeePatchBodyCancellationReason]
        if isinstance(_cancellation_reason, Unset):
            cancellation_reason = UNSET
        else:
            cancellation_reason = check_cancel_attendee_patch_body_cancellation_reason(_cancellation_reason)

        apply_to_repeats = d.pop("apply_to_repeats", UNSET)

        cancel_attendee_patch_body = cls(
            cancellation_note=cancellation_note,
            cancellation_reason=cancellation_reason,
            apply_to_repeats=apply_to_repeats,
        )

        cancel_attendee_patch_body.additional_properties = d
        return cancel_attendee_patch_body
