...
from ...models.list_treatment_note_templates_get_order import (
...
def _get_kwargs(
    *,
    ...
    order: Union[Unset, ListTreatmentNoteTemplatesGetOrder] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        order (Union[Unset, ListTreatmentNoteTemplatesGetOrder]):
