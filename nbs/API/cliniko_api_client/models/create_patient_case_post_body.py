...
from ..models.create_patient_case_post_body_referral_type import (
    CreatePatientCasePostBodyReferralType,
    check_create_patient_case_post_body_referral_type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreatePatientCasePostBody")


@_attrs_define
class CreatePatientCasePostBody:
    """
    Attributes:
        ...
        referral_type (Union[Unset, CreatePatientCasePostBodyReferralType]):
    ...
    referral_type: Union[Unset, CreatePatientCasePostBodyReferralType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_referral_type, Unset):
            ...
            referral_type = check_create_patient_case_post_body_referral_type(_referral_type)
        ...
        create_patient_case_post_body = cls(
            closed=closed,
        ...
        create_patient_case_post_body.additional_properties = d
        return create_patient_case_post_body
