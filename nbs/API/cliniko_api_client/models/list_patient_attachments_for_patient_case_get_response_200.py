...
if TYPE_CHECKING:
    ...
    from ..models.list_patient_attachments_for_patient_case_get_response_200_links import (
...
T = TypeVar("T", bound="ListPatientAttachmentsForPatientCaseGetResponse200")


@_attrs_define
class ListPatientAttachmentsForPatientCaseGetResponse200:
    """
    Attributes:
        ...
        links (Union[Unset, ListPatientAttachmentsForPatientCaseGetResponse200Links]):
    """
    ...
    links: Union[Unset, "ListPatientAttachmentsForPatientCaseGetResponse200Links"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = ListPatientAttachmentsForPatientCaseGetResponse200Links.from_dict(_links)

        list_patient_attachments_for_patient_case_get_response_200 = cls(
            patient_attachments=patient_attachments,
            total_entries=total_entries,
            links=links,
        )

        list_patient_attachments_for_patient_case_get_response_200.additional_properties = d
        return list_patient_attachments_for_patient_case_get_response_200
