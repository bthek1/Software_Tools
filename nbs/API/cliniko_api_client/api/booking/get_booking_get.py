...
) -> Optional[Union["GroupAppointment", "IndividualAppointment", "UnavailableBlock"]]:
    if response.status_code == 200:

        def _parse_response_200(data: object) -> Union["GroupAppointment", "IndividualAppointment", "UnavailableBlock"]:
            try:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union["GroupAppointment", "IndividualAppointment", "UnavailableBlock"]]:
    return Response(
