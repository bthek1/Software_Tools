...
from ..models.create_appointment_type_post_body_online_bookings_lead_time_hours import (
    CreateAppointmentTypePostBodyOnlineBookingsLeadTimeHours,
    check_create_appointment_type_post_body_online_bookings_lead_time_hours,
)
from ..models.create_appointment_type_post_body_online_payments_mode import (
    CreateAppointmentTypePostBodyOnlinePaymentsMode,
    check_create_appointment_type_post_body_online_payments_mode,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateAppointmentTypePostBody")


@_attrs_define
class CreateAppointmentTypePostBody:
    """
    Attributes:
        ...
        online_bookings_lead_time_hours (Union[Unset, CreateAppointmentTypePostBodyOnlineBookingsLeadTimeHours]):
        online_payments_mode (Union[Unset, CreateAppointmentTypePostBodyOnlinePaymentsMode]):
    ...
    online_bookings_lead_time_hours: Union[Unset, CreateAppointmentTypePostBodyOnlineBookingsLeadTimeHours] = UNSET
    online_payments_mode: Union[Unset, CreateAppointmentTypePostBodyOnlinePaymentsMode] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_online_bookings_lead_time_hours, Unset):
            ...
            online_bookings_lead_time_hours = check_create_appointment_type_post_body_online_bookings_lead_time_hours(
        ...
        if isinstance(_online_payments_mode, Unset):
            ...
            online_payments_mode = check_create_appointment_type_post_body_online_payments_mode(_online_payments_mode)
        ...
        create_appointment_type_post_body = cls(
        ...
        create_appointment_type_post_body.additional_properties = d
        return create_appointment_type_post_body
