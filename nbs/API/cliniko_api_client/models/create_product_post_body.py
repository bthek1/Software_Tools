...
T = TypeVar("T", bound="CreateProductPostBody")


@_attrs_define
class CreateProductPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_product_post_body.additional_properties = d
        return create_product_post_body
