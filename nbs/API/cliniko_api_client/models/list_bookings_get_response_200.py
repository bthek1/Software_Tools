...
if TYPE_CHECKING:
    ...
    from ..models.list_bookings_get_response_200_links import ListBookingsGetResponse200Links
    from ..models.unavailable_block import UnavailableBlock


T = TypeVar("T", bound="ListBookingsGetResponse200")


@_attrs_define
class ListBookingsGetResponse200:
    """
    Attributes:
        ...
        links (Union[Unset, ListBookingsGetResponse200Links]):
    """
    ...
    links: Union[Unset, "ListBookingsGetResponse200Links"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = ListBookingsGetResponse200Links.from_dict(_links)

        list_bookings_get_response_200 = cls(
            bookings=bookings,
            total_entries=total_entries,
            links=links,
        )

        list_bookings_get_response_200.additional_properties = d
        return list_bookings_get_response_200
