...
if TYPE_CHECKING:
    from ..models.list_medical_alerts_for_patient_get_response_200_links import (
        ListMedicalAlertsForPatientGetResponse200Links,
    )
    from ..models.medical_alert import MedicalAlert


T = TypeVar("T", bound="ListMedicalAlertsForPatientGetResponse200")


@_attrs_define
class ListMedicalAlertsForPatientGetResponse200:
    """
    Attributes:
        medical_alerts (Union[Unset, List['MedicalAlert']]):
        total_entries (Union[Unset, int]):  Example: 1.
        links (Union[Unset, ListMedicalAlertsForPatientGetResponse200Links]):
    """

    medical_alerts: Union[Unset, List["MedicalAlert"]] = UNSET
    total_entries: Union[Unset, int] = UNSET
    links: Union[Unset, "ListMedicalAlertsForPatientGetResponse200Links"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = ListMedicalAlertsForPatientGetResponse200Links.from_dict(_links)

        list_medical_alerts_for_patient_get_response_200 = cls(
            medical_alerts=medical_alerts,
            total_entries=total_entries,
            links=links,
        )

        list_medical_alerts_for_patient_get_response_200.additional_properties = d
        return list_medical_alerts_for_patient_get_response_200
