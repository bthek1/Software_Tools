...
if TYPE_CHECKING:
    from ..models.full_patient_export_content_type_0 import FullPatientExportContentType0
    from ..models.full_patient_export_links import FullPatientExportLinks
    from ..models.full_patient_export_patient import FullPatientExportPatient
    from ..models.full_patient_export_user import FullPatientExportUser


T = TypeVar("T", bound="FullPatientExport")


@_attrs_define
class FullPatientExport:
    """
    Attributes:
        archived_at (Union[None, Unset, datetime.datetime]):
        content (Union['FullPatientExportContentType0', None, Unset]):
        content_type (Union[None, Unset, str]): mime type Example: text/plain.
        created_at (Union[Unset, datetime.datetime]):
        description (Union[None, Unset, str]):
        filename (Union[None, Unset, str]):
        id (Union[Unset, str]):
        links (Union[Unset, FullPatientExportLinks]):
        patient (Union[Unset, FullPatientExportPatient]):
        ...
        user (Union[Unset, FullPatientExportUser]):
    """

    archived_at: Union[None, Unset, datetime.datetime] = UNSET
    content: Union["FullPatientExportContentType0", None, Unset] = UNSET
    content_type: Union[None, Unset, str] = UNSET
    created_at: Union[Unset, datetime.datetime] = UNSET
    description: Union[None, Unset, str] = UNSET
    filename: Union[None, Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    links: Union[Unset, "FullPatientExportLinks"] = UNSET
    patient: Union[Unset, "FullPatientExportPatient"] = UNSET
    ...
    user: Union[Unset, "FullPatientExportUser"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.content, Unset):
            content = UNSET
        elif isinstance(self.content, FullPatientExportContentType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_content(data: object) -> Union["FullPatientExportContentType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                content_type_0 = FullPatientExportContentType0.from_dict(data)

                return content_type_0
            except:  # noqa: E722
                pass
            return cast(Union["FullPatientExportContentType0", None, Unset], data)
        ...
        if isinstance(_links, Unset):
            ...
            links = FullPatientExportLinks.from_dict(_links)
        ...
        if isinstance(_patient, Unset):
            ...
            patient = FullPatientExportPatient.from_dict(_patient)
        ...
        if isinstance(_user, Unset):
            ...
            user = FullPatientExportUser.from_dict(_user)

        full_patient_export = cls(
        ...
        full_patient_export.additional_properties = d
        return full_patient_export
