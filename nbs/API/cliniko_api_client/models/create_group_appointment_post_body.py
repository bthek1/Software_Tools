...
if TYPE_CHECKING:
    from ..models.create_group_appointment_post_body_repeat_rule_type_0 import (
        CreateGroupAppointmentPostBodyRepeatRuleType0,
    )


T = TypeVar("T", bound="CreateGroupAppointmentPostBody")


@_attrs_define
class CreateGroupAppointmentPostBody:
    """
    Attributes:
        ...
        repeat_rule (Union['CreateGroupAppointmentPostBodyRepeatRuleType0', None, Unset]):
    """
    ...
    repeat_rule: Union["CreateGroupAppointmentPostBodyRepeatRuleType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.repeat_rule, Unset):
            repeat_rule = UNSET
        elif isinstance(self.repeat_rule, CreateGroupAppointmentPostBodyRepeatRuleType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_repeat_rule(data: object) -> Union["CreateGroupAppointmentPostBodyRepeatRuleType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                repeat_rule_type_0 = CreateGroupAppointmentPostBodyRepeatRuleType0.from_dict(data)

                return repeat_rule_type_0
            except:  # noqa: E722
                pass
            return cast(Union["CreateGroupAppointmentPostBodyRepeatRuleType0", None, Unset], data)

        repeat_rule = _parse_repeat_rule(d.pop("repeat_rule", UNSET))

        create_group_appointment_post_body = cls(
        ...
        create_group_appointment_post_body.additional_properties = d
        return create_group_appointment_post_body
