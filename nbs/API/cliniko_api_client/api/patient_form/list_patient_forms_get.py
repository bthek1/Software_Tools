...
from ...models.list_patient_forms_get_order import ListPatientFormsGetOrder
...
def _get_kwargs(
    *,
    ...
    order: Union[Unset, ListPatientFormsGetOrder] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        order (Union[Unset, ListPatientFormsGetOrder]):
