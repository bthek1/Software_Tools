...
if TYPE_CHECKING:
    from ..models.list_active_patient_cases_get_response_200_links import ListActivePatientCasesGetResponse200Links
    from ..models.patient_case import PatientCase


T = TypeVar("T", bound="ListActivePatientCasesGetResponse200")


@_attrs_define
class ListActivePatientCasesGetResponse200:
    """
    Attributes:
        patient_cases (Union[Unset, List['PatientCase']]):
        total_entries (Union[Unset, int]):  Example: 1.
        links (Union[Unset, ListActivePatientCasesGetResponse200Links]):
    """

    patient_cases: Union[Unset, List["PatientCase"]] = UNSET
    total_entries: Union[Unset, int] = UNSET
    links: Union[Unset, "ListActivePatientCasesGetResponse200Links"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = ListActivePatientCasesGetResponse200Links.from_dict(_links)

        list_active_patient_cases_get_response_200 = cls(
            patient_cases=patient_cases,
            total_entries=total_entries,
            links=links,
        )

        list_active_patient_cases_get_response_200.additional_properties = d
        return list_active_patient_cases_get_response_200
