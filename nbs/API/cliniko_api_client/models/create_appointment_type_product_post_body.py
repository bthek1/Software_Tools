...
T = TypeVar("T", bound="CreateAppointmentTypeProductPostBody")


@_attrs_define
class CreateAppointmentTypeProductPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_appointment_type_product_post_body = cls(
        ...
        create_appointment_type_product_post_body.additional_properties = d
        return create_appointment_type_product_post_body
