...
from ...models.list_treatment_notes_get_order import ListTreatmentNotesGetOrder
...
def _get_kwargs(
    *,
    ...
    order: Union[Unset, ListTreatmentNotesGetOrder] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        order (Union[Unset, ListTreatmentNotesGetOrder]):
