...
T = TypeVar("T", bound="UpdateAppointmentTypeBillableItemPatchBody")


@_attrs_define
class UpdateAppointmentTypeBillableItemPatchBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_appointment_type_billable_item_patch_body = cls(
        ...
        update_appointment_type_billable_item_patch_body.additional_properties = d
        return update_appointment_type_billable_item_patch_body
