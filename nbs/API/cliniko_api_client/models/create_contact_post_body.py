...
from ..models.create_contact_post_body_doctor_type import (
    CreateContactPostBodyDoctorType,
    check_create_contact_post_body_doctor_type,
)
from ..models.create_contact_post_body_type_code import (
    CreateContactPostBodyTypeCode,
    check_create_contact_post_body_type_code,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.create_contact_post_body_phone_numbers_item import CreateContactPostBodyPhoneNumbersItem


T = TypeVar("T", bound="CreateContactPostBody")


@_attrs_define
class CreateContactPostBody:
    """
    Attributes:
        ...
        doctor_type (Union[Unset, CreateContactPostBodyDoctorType]):
        ...
        type_code (Union[Unset, CreateContactPostBodyTypeCode]):
        phone_numbers (Union[Unset, List['CreateContactPostBodyPhoneNumbersItem']]):
    """
    ...
    doctor_type: Union[Unset, CreateContactPostBodyDoctorType] = UNSET
    ...
    type_code: Union[Unset, CreateContactPostBodyTypeCode] = UNSET
    phone_numbers: Union[Unset, List["CreateContactPostBodyPhoneNumbersItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_doctor_type, Unset):
            ...
            doctor_type = check_create_contact_post_body_doctor_type(_doctor_type)
        ...
        if isinstance(_type_code, Unset):
            ...
            type_code = check_create_contact_post_body_type_code(_type_code)

        phone_numbers = []
        _phone_numbers = d.pop("phone_numbers", UNSET)
        for phone_numbers_item_data in _phone_numbers or []:
            phone_numbers_item = CreateContactPostBodyPhoneNumbersItem.from_dict(phone_numbers_item_data)

            phone_numbers.append(phone_numbers_item)

        create_contact_post_body = cls(
            address_1=address_1,
            address_2=address_2,
            address_3=address_3,
            city=city,
        ...
        create_contact_post_body.additional_properties = d
        return create_contact_post_body
