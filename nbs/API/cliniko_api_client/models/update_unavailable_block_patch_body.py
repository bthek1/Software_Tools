...
if TYPE_CHECKING:
    from ..models.update_unavailable_block_patch_body_repeat_rule_type_0 import (
        UpdateUnavailableBlockPatchBodyRepeatRuleType0,
    )


T = TypeVar("T", bound="UpdateUnavailableBlockPatchBody")


@_attrs_define
class UpdateUnavailableBlockPatchBody:
    """
    Attributes:
        ...
        repeat_rule (Union['UpdateUnavailableBlockPatchBodyRepeatRuleType0', None, Unset]):
    """
    ...
    repeat_rule: Union["UpdateUnavailableBlockPatchBodyRepeatRuleType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.repeat_rule, Unset):
            repeat_rule = UNSET
        elif isinstance(self.repeat_rule, UpdateUnavailableBlockPatchBodyRepeatRuleType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_repeat_rule(data: object) -> Union["UpdateUnavailableBlockPatchBodyRepeatRuleType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                repeat_rule_type_0 = UpdateUnavailableBlockPatchBodyRepeatRuleType0.from_dict(data)

                return repeat_rule_type_0
            except:  # noqa: E722
                pass
            return cast(Union["UpdateUnavailableBlockPatchBodyRepeatRuleType0", None, Unset], data)

        repeat_rule = _parse_repeat_rule(d.pop("repeat_rule", UNSET))

        update_unavailable_block_patch_body = cls(
        ...
        update_unavailable_block_patch_body.additional_properties = d
        return update_unavailable_block_patch_body
