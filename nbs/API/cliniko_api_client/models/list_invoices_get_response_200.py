...
if TYPE_CHECKING:
    ...
    from ..models.list_invoices_get_response_200_links import ListInvoicesGetResponse200Links


T = TypeVar("T", bound="ListInvoicesGetResponse200")


@_attrs_define
class ListInvoicesGetResponse200:
    """
    Attributes:
        invoices (Union[Unset, List['Invoice']]):
        total_entries (Union[Unset, int]):  Example: 1.
        links (Union[Unset, ListInvoicesGetResponse200Links]):
    """

    invoices: Union[Unset, List["Invoice"]] = UNSET
    total_entries: Union[Unset, int] = UNSET
    links: Union[Unset, "ListInvoicesGetResponse200Links"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = ListInvoicesGetResponse200Links.from_dict(_links)

        list_invoices_get_response_200 = cls(
            invoices=invoices,
            total_entries=total_entries,
            links=links,
        )

        list_invoices_get_response_200.additional_properties = d
        return list_invoices_get_response_200
