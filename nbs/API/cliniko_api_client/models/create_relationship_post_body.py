...
from ..models.create_relationship_post_body_relation import (
    CreateRelationshipPostBodyRelation,
    check_create_relationship_post_body_relation,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateRelationshipPostBody")


@_attrs_define
class CreateRelationshipPostBody:
    """
    Attributes:
        patient_id (Union[Unset, str]): patient id Example: 1.
        related_patient_id (Union[Unset, str]): patient id Example: 1.
        relation (Union[Unset, CreateRelationshipPostBodyRelation]): | Enum Value | Description |
            |---|---|
            |10|Parent|
            |20|Child|
            |30|Sibling|
    ...
    relation: Union[Unset, CreateRelationshipPostBodyRelation] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        relation: Union[Unset, CreateRelationshipPostBodyRelation]
        if isinstance(_relation, Unset):
            relation = UNSET
        else:
            relation = check_create_relationship_post_body_relation(_relation)

        create_relationship_post_body = cls(
            patient_id=patient_id,
            related_patient_id=related_patient_id,
            relation=relation,
        )

        create_relationship_post_body.additional_properties = d
        return create_relationship_post_body
