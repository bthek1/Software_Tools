...
from ..models.update_individual_appointment_patch_body_repeat_rule_type_0_repeat_type import (
    UpdateIndividualAppointmentPatchBodyRepeatRuleType0RepeatType,
    check_update_individual_appointment_patch_body_repeat_rule_type_0_repeat_type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateIndividualAppointmentPatchBodyRepeatRuleType0")


@_attrs_define
class UpdateIndividualAppointmentPatchBodyRepeatRuleType0:
    """
    Attributes:
        number_of_repeats (Union[None, Unset, int]):
        repeat_type (Union[Unset, UpdateIndividualAppointmentPatchBodyRepeatRuleType0RepeatType]):
        repeating_interval (Union[None, Unset, int]):
    """

    number_of_repeats: Union[None, Unset, int] = UNSET
    repeat_type: Union[Unset, UpdateIndividualAppointmentPatchBodyRepeatRuleType0RepeatType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_repeat_type, Unset):
            ...
            repeat_type = check_update_individual_appointment_patch_body_repeat_rule_type_0_repeat_type(_repeat_type)
        ...
        update_individual_appointment_patch_body_repeat_rule_type_0 = cls(
            number_of_repeats=number_of_repeats,
            repeat_type=repeat_type,
            repeating_interval=repeating_interval,
        )

        update_individual_appointment_patch_body_repeat_rule_type_0.additional_properties = d
        return update_individual_appointment_patch_body_repeat_rule_type_0
