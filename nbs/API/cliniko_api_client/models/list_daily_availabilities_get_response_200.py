...
if TYPE_CHECKING:
    ...
    from ..models.list_daily_availabilities_get_response_200_links import ListDailyAvailabilitiesGetResponse200Links


T = TypeVar("T", bound="ListDailyAvailabilitiesGetResponse200")


@_attrs_define
class ListDailyAvailabilitiesGetResponse200:
    """
    Attributes:
        daily_availabilities (Union[Unset, List['DailyAvailability']]):
        total_entries (Union[Unset, int]):  Example: 1.
        links (Union[Unset, ListDailyAvailabilitiesGetResponse200Links]):
    """

    daily_availabilities: Union[Unset, List["DailyAvailability"]] = UNSET
    total_entries: Union[Unset, int] = UNSET
    links: Union[Unset, "ListDailyAvailabilitiesGetResponse200Links"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = ListDailyAvailabilitiesGetResponse200Links.from_dict(_links)

        list_daily_availabilities_get_response_200 = cls(
            daily_availabilities=daily_availabilities,
            total_entries=total_entries,
            links=links,
        )

        list_daily_availabilities_get_response_200.additional_properties = d
        return list_daily_availabilities_get_response_200
