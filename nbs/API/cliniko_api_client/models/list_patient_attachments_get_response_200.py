...
if TYPE_CHECKING:
    ...
    from ..models.list_patient_attachments_get_response_200_links import ListPatientAttachmentsGetResponse200Links
    from ..models.uploaded_patient_attachment import UploadedPatientAttachment


T = TypeVar("T", bound="ListPatientAttachmentsGetResponse200")


@_attrs_define
class ListPatientAttachmentsGetResponse200:
    """
    Attributes:
        ...
        links (Union[Unset, ListPatientAttachmentsGetResponse200Links]):
    """
    ...
    links: Union[Unset, "ListPatientAttachmentsGetResponse200Links"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = ListPatientAttachmentsGetResponse200Links.from_dict(_links)

        list_patient_attachments_get_response_200 = cls(
            patient_attachments=patient_attachments,
            total_entries=total_entries,
            links=links,
        )

        list_patient_attachments_get_response_200.additional_properties = d
        return list_patient_attachments_get_response_200
